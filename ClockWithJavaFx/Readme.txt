...
Though, it is not a direct copy, it should be noted that this program is implemented by following the instructions in book - "Y.Daniel Liang (2015).Introduction to Java Programming, Comprehensive Version, 10th Ed." On top of it, I added a few functionalities enable and disable automatically updating the clock every second.
